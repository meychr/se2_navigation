/*
 * YawRateControllerRos.cpp
 *
 *  Created on: Jul 06, 2020
 *      Author: meyerc, jelavice
 */

#include "pure_pursuit_ros/YawRateControllerRos.hpp"
...
YawRateControllerRos::YawRateControllerRos(ros::NodeHandle* nh) : BASE(), nh_(nh) {
  initRos();
}

void YawRateControllerRos::initRos() {
...
bool YawRateControllerRos::advanceImpl() {
...
void YawRateControllerRos::publishAnchorPoint() const {
...
void YawRateControllerRos::publishPathSegment() const {
...
void YawRateControllerRos::publishLookaheadPoint() const {
...
void YawRateControllerRos::publishP1() const {
...
void YawRateControllerRos::publishP2() const {
...
std::unique_ptr<HeadingController> createYawRateControllerRos(const YawRateCtrlParameters& parameters, ros::NodeHandle* nh) {
  std::unique_ptr<YawRateControllerRos> ctrl = std::make_unique<YawRateControllerRos>(nh);
